...
type SiteSiteMetadata = {
  ...
  readonly locate: Maybe<Scalars['String']>;
...
type ContentfulArticles = ContentfulReference & ContentfulEntry & Node & {
  ...
  readonly createdArticleDate: Maybe<Scalars['Date']>;
  readonly article: Maybe<ContentfulArticlesArticle>;
...
type ContentfulArticles_createdArticleDateArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type ContentfulArticlesArticle = {
...
type ContentfulCategory = ContentfulReference & ContentfulEntry & Node & {
  ...
  readonly articles: Maybe<ReadonlyArray<Maybe<ContentfulArticles>>>;
  readonly spaceId: Maybe<Scalars['String']>;
  readonly createdAt: Maybe<Scalars['Date']>;
  readonly updatedAt: Maybe<Scalars['Date']>;
...
type Query_contentfulArticlesArgs = {
  ...
  createdArticleDate: Maybe<DateQueryOperatorInput>;
  article: Maybe<ContentfulArticlesArticleFilterInput>;
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly locate: Maybe<StringQueryOperatorInput>;
...
type ContentfulArticlesArticleFilterInput = {
...
type ContentfulCategoryFilterInput = {
  ...
  readonly articles: Maybe<ContentfulArticlesFilterListInput>;
  readonly spaceId: Maybe<StringQueryOperatorInput>;
  readonly createdAt: Maybe<DateQueryOperatorInput>;
  readonly updatedAt: Maybe<DateQueryOperatorInput>;
...
type ContentfulArticlesFilterListInput = {
  readonly elemMatch: Maybe<ContentfulArticlesFilterInput>;
};
...
type ContentfulArticlesFilterInput = {
  ...
  readonly createdArticleDate: Maybe<DateQueryOperatorInput>;
  readonly article: Maybe<ContentfulArticlesArticleFilterInput>;
...
type ContentfulArticlesFieldsEnum =
  ...
  | 'article.raw'
  | 'article.references'
  | 'article.references.contentful_id'
  | 'article.references.id'
  | 'article.references.spaceId'
  | 'article.references.createdAt'
  | 'article.references.updatedAt'
  | 'article.references.file.url'
  | 'article.references.file.fileName'
  | 'article.references.file.contentType'
  | 'article.references.title'
  | 'article.references.description'
  | 'article.references.node_locale'
  | 'article.references.sys.type'
  | 'article.references.sys.revision'
  | 'article.references.fixed.base64'
  | 'article.references.fixed.tracedSVG'
  | 'article.references.fixed.aspectRatio'
  | 'article.references.fixed.width'
  | 'article.references.fixed.height'
  | 'article.references.fixed.src'
  | 'article.references.fixed.srcSet'
  | 'article.references.fixed.srcWebp'
  | 'article.references.fixed.srcSetWebp'
  | 'article.references.fluid.base64'
  | 'article.references.fluid.tracedSVG'
  | 'article.references.fluid.aspectRatio'
  | 'article.references.fluid.src'
  | 'article.references.fluid.srcSet'
  | 'article.references.fluid.srcWebp'
  | 'article.references.fluid.srcSetWebp'
  | 'article.references.fluid.sizes'
  | 'article.references.gatsbyImageData'
  | 'article.references.resize.base64'
  | 'article.references.resize.tracedSVG'
  | 'article.references.resize.src'
  | 'article.references.resize.width'
  | 'article.references.resize.height'
  | 'article.references.resize.aspectRatio'
  | 'article.references.parent.id'
  | 'article.references.parent.children'
  | 'article.references.children'
  | 'article.references.children.id'
  | 'article.references.children.children'
  | 'article.references.internal.content'
  | 'article.references.internal.contentDigest'
  | 'article.references.internal.description'
  | 'article.references.internal.fieldOwners'
  | 'article.references.internal.ignoreType'
  | 'article.references.internal.mediaType'
  | 'article.references.internal.owner'
  | 'article.references.internal.type'
  ...
  | 'category.articles'
  | 'category.articles.contentful_id'
  | 'category.articles.id'
  | 'category.articles.node_locale'
  | 'category.articles.title'
  | 'category.articles.slug'
  | 'category.articles.createdArticleDate'
  | 'category.articles.article.raw'
  | 'category.articles.article.references'
  | 'category.articles.eyecatch.contentful_id'
  | 'category.articles.eyecatch.id'
  | 'category.articles.eyecatch.spaceId'
  | 'category.articles.eyecatch.createdAt'
  | 'category.articles.eyecatch.updatedAt'
  | 'category.articles.eyecatch.title'
  | 'category.articles.eyecatch.description'
  | 'category.articles.eyecatch.node_locale'
  | 'category.articles.eyecatch.gatsbyImageData'
  | 'category.articles.eyecatch.children'
  | 'category.articles.category'
  | 'category.articles.category.contentful_id'
  | 'category.articles.category.id'
  | 'category.articles.category.node_locale'
  | 'category.articles.category.category'
  | 'category.articles.category.categorySlug'
  | 'category.articles.category.articles'
  | 'category.articles.category.spaceId'
  | 'category.articles.category.createdAt'
  | 'category.articles.category.updatedAt'
  | 'category.articles.category.children'
  | 'category.articles.spaceId'
  | 'category.articles.createdAt'
  | 'category.articles.updatedAt'
  | 'category.articles.sys.type'
  | 'category.articles.sys.revision'
  | 'category.articles.parent.id'
  | 'category.articles.parent.children'
  | 'category.articles.children'
  | 'category.articles.children.id'
  | 'category.articles.children.children'
  | 'category.articles.internal.content'
  | 'category.articles.internal.contentDigest'
  | 'category.articles.internal.description'
  | 'category.articles.internal.fieldOwners'
  | 'category.articles.internal.ignoreType'
  | 'category.articles.internal.mediaType'
  | 'category.articles.internal.owner'
  | 'category.articles.internal.type'
  | 'category.spaceId'
  | 'category.createdAt'
  | 'category.updatedAt'
  | 'category.sys.type'
...
type ContentfulCategoryFieldsEnum =
  ...
  | 'categorySlug'
  | 'articles'
  | 'articles.contentful_id'
  | 'articles.id'
  | 'articles.node_locale'
  | 'articles.title'
  | 'articles.slug'
  | 'articles.createdArticleDate'
  | 'articles.article.raw'
  | 'articles.article.references'
  | 'articles.article.references.contentful_id'
  | 'articles.article.references.id'
  | 'articles.article.references.spaceId'
  | 'articles.article.references.createdAt'
  | 'articles.article.references.updatedAt'
  | 'articles.article.references.title'
  | 'articles.article.references.description'
  | 'articles.article.references.node_locale'
  | 'articles.article.references.gatsbyImageData'
  | 'articles.article.references.children'
  | 'articles.eyecatch.contentful_id'
  | 'articles.eyecatch.id'
  | 'articles.eyecatch.spaceId'
  | 'articles.eyecatch.createdAt'
  | 'articles.eyecatch.updatedAt'
  | 'articles.eyecatch.file.url'
  | 'articles.eyecatch.file.fileName'
  | 'articles.eyecatch.file.contentType'
  | 'articles.eyecatch.title'
  | 'articles.eyecatch.description'
  | 'articles.eyecatch.node_locale'
  | 'articles.eyecatch.sys.type'
  | 'articles.eyecatch.sys.revision'
  | 'articles.eyecatch.fixed.base64'
  | 'articles.eyecatch.fixed.tracedSVG'
  | 'articles.eyecatch.fixed.aspectRatio'
  | 'articles.eyecatch.fixed.width'
  | 'articles.eyecatch.fixed.height'
  | 'articles.eyecatch.fixed.src'
  | 'articles.eyecatch.fixed.srcSet'
  | 'articles.eyecatch.fixed.srcWebp'
  | 'articles.eyecatch.fixed.srcSetWebp'
  | 'articles.eyecatch.fluid.base64'
  | 'articles.eyecatch.fluid.tracedSVG'
  | 'articles.eyecatch.fluid.aspectRatio'
  | 'articles.eyecatch.fluid.src'
  | 'articles.eyecatch.fluid.srcSet'
  | 'articles.eyecatch.fluid.srcWebp'
  | 'articles.eyecatch.fluid.srcSetWebp'
  | 'articles.eyecatch.fluid.sizes'
  | 'articles.eyecatch.gatsbyImageData'
  | 'articles.eyecatch.resize.base64'
  | 'articles.eyecatch.resize.tracedSVG'
  | 'articles.eyecatch.resize.src'
  | 'articles.eyecatch.resize.width'
  | 'articles.eyecatch.resize.height'
  | 'articles.eyecatch.resize.aspectRatio'
  | 'articles.eyecatch.parent.id'
  | 'articles.eyecatch.parent.children'
  | 'articles.eyecatch.children'
  | 'articles.eyecatch.children.id'
  | 'articles.eyecatch.children.children'
  | 'articles.eyecatch.internal.content'
  | 'articles.eyecatch.internal.contentDigest'
  | 'articles.eyecatch.internal.description'
  | 'articles.eyecatch.internal.fieldOwners'
  | 'articles.eyecatch.internal.ignoreType'
  | 'articles.eyecatch.internal.mediaType'
  | 'articles.eyecatch.internal.owner'
  | 'articles.eyecatch.internal.type'
  | 'articles.category'
  | 'articles.category.contentful_id'
  | 'articles.category.id'
  | 'articles.category.node_locale'
  | 'articles.category.category'
  | 'articles.category.categorySlug'
  | 'articles.category.articles'
  | 'articles.category.articles.contentful_id'
  | 'articles.category.articles.id'
  | 'articles.category.articles.node_locale'
  | 'articles.category.articles.title'
  | 'articles.category.articles.slug'
  | 'articles.category.articles.createdArticleDate'
  | 'articles.category.articles.category'
  | 'articles.category.articles.spaceId'
  | 'articles.category.articles.createdAt'
  | 'articles.category.articles.updatedAt'
  | 'articles.category.articles.children'
  | 'articles.category.spaceId'
  | 'articles.category.createdAt'
  | 'articles.category.updatedAt'
  | 'articles.category.sys.type'
  | 'articles.category.sys.revision'
  | 'articles.category.parent.id'
  | 'articles.category.parent.children'
  | 'articles.category.children'
  | 'articles.category.children.id'
  | 'articles.category.children.children'
  | 'articles.category.internal.content'
  | 'articles.category.internal.contentDigest'
  | 'articles.category.internal.description'
  | 'articles.category.internal.fieldOwners'
  | 'articles.category.internal.ignoreType'
  | 'articles.category.internal.mediaType'
  | 'articles.category.internal.owner'
  | 'articles.category.internal.type'
  | 'articles.spaceId'
  | 'articles.createdAt'
  | 'articles.updatedAt'
  | 'articles.sys.type'
  | 'articles.sys.revision'
  | 'articles.parent.id'
  | 'articles.parent.parent.id'
  | 'articles.parent.parent.children'
  | 'articles.parent.children'
  | 'articles.parent.children.id'
  | 'articles.parent.children.children'
  | 'articles.parent.internal.content'
  | 'articles.parent.internal.contentDigest'
  | 'articles.parent.internal.description'
  | 'articles.parent.internal.fieldOwners'
  | 'articles.parent.internal.ignoreType'
  | 'articles.parent.internal.mediaType'
  | 'articles.parent.internal.owner'
  | 'articles.parent.internal.type'
  | 'articles.children'
  | 'articles.children.id'
  | 'articles.children.parent.id'
  | 'articles.children.parent.children'
  | 'articles.children.children'
  | 'articles.children.children.id'
  | 'articles.children.children.children'
  | 'articles.children.internal.content'
  | 'articles.children.internal.contentDigest'
  | 'articles.children.internal.description'
  | 'articles.children.internal.fieldOwners'
  | 'articles.children.internal.ignoreType'
  | 'articles.children.internal.mediaType'
  | 'articles.children.internal.owner'
  | 'articles.children.internal.type'
  | 'articles.internal.content'
  | 'articles.internal.contentDigest'
  | 'articles.internal.description'
  | 'articles.internal.fieldOwners'
  | 'articles.internal.ignoreType'
  | 'articles.internal.mediaType'
  | 'articles.internal.owner'
  | 'articles.internal.type'
  | 'spaceId'
  | 'createdAt'
  | 'updatedAt'
  | 'sys.type'
...
type cUsersnhs90215DesktopMakoHatoVer0SrctemplatesarticlepostTemplateTsx3709916888QueryVariables = Exact<{
  id: Scalars['String'];
}>;


type cUsersnhs90215DesktopMakoHatoVer0SrctemplatesarticlepostTemplateTsx3709916888Query = { readonly contentfulArticles: Maybe<(
...
type cUsersnhs90215DesktopMakoHatoVer0SrctemplatesblogTemplateTsx1373623850QueryVariables = Exact<{
  skip: Scalars['Int'];
  limit: Scalars['Int'];
}>;


type cUsersnhs90215DesktopMakoHatoVer0SrctemplatesblogTemplateTsx1373623850Query = { readonly allContentfulArticles: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<ContentfulArticles, 'title' | 'id' | 'slug'>
        & { readonly eyecatch: Maybe<Pick<ContentfulAsset, 'gatsbyImageData' | 'description'>> }
      ) }> } };

type cUsersnhs90215DesktopMakoHatoVer0SrctemplatescategoryTemplateTsx2348830171QueryVariables = Exact<{
...
type cUsersnhs90215DesktopMakoHatoVer0SrctemplatescategoryTemplateTsx2348830171Query = { readonly allContentfulArticles: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<ContentfulArticles, 'title' | 'id' | 'slug'>
        & { readonly eyecatch: Maybe<Pick<ContentfulAsset, 'gatsbyImageData' | 'description'>> }
      ) }> } };
...
type cUsersnhs90215DesktopMakoHatoVer0SrcpagesindexTsx2146525424QueryVariables = Exact<{ [key: string]: never; }>;


type cUsersnhs90215DesktopMakoHatoVer0SrcpagesindexTsx2146525424Query = { readonly allContentfulArticles: { readonly edges: ReadonlyArray<{ readonly node: Pick<ContentfulArticles, 'title' | 'id' | 'slug'> }> } };
